...
class FPDF(FPDF, HTMLMixin):
    def setLogo(self):
        ...
        self.cell(12, 3, txt='SECCION III', border=1, ln=0, align='C')
        #self.ln(1)
        self.set_xy(8, 29)
        self.cell(txt='JALISCO')
        self.set_xy(40, 5)
        self.set_font('Arial', 'B',14)
        self.cell(txt='Sindicato Nacional de Trabajadores del Seguro Social', border=1, align='C')
        self.set_xy(70, 13)
        self.set_font('Arial', 'B', 12)
        self.cell(txt='CÉDULA DE AFILIACIÓN', border=1, align='C')
        self.set_xy(55, 18)
        self.set_font('Arial', '', 5)
        self.multi_cell(90,2, l, 1, 'J')
        #self.ln(1)
    def setData(self):
        #self.set_xy(5, 50)
        path_dir = os.path.dirname('C:\\Users\\jazyi\\flask-projects\\cedulaOriginal\\static\\')
    ...
    def reverseFace(self):
        ...
        # rect(x, y, w, h, style)
        self.rect(x=30, y=20, w=140, h=180)

        self.set_xy(100, 25)
        self.set_font('Arial', 'B', 7)
        self.cell(10, 3, 'Aviso de Privacidad', 1, 1, 'C')

        self.set_margins(32, 38)
        self.set_font('Arial', '', 6.5)
        self.set_stretching(100)
        # write(h, txt)
        self.write_html("""<p><B>Sindicato Nacional de Trabajadores del Seguro Social</B>, con domicilio <B>en calle Zamora 107, colonia Condesa, Alcaldía
                            <p>Cuauhtémoc,  C.P.  06140,  Ciudad de México</B>, en cumplimiento a los artículos 2, fracción II, 3 fracción 6,7,8,12,4,15 y
                            <p>demás  relativos  de  la  Ley  Federal de  Protección  de datos Personales en Poseción de los Particulares, su Reglamento y
                            <p>Lineamientos; es el <B>responsable</B> de la obtención, uso, divulgación o almacenamiento y protección de sus datos
                            <p>personales, y al respecto le informo lo siguiente:
                            <p>Los datos personales que recabamos de Usted en la cédula de afiliación, los utilizaremos para las siguientes
                            <p>finalidades que son necesarias para el desarrollo de las actividades que nuestro marco estatutario establece:
                            <p><B>Dar cumplimiento a la fracción X del artículo 13 que se refiere a informar al secretario del Interior y propaganda: el
                            <p>domicilio o cambio de él así como los datos previstos en los padrones.
                            <p>Cumplir con la fracción IV del artículo 77 que señala que la Secretaría del Interior y Propaganda debe contar con el
                            <p>registro de los miembros del Sindicato (nombre completo, fecha y lugar de nacimiento, estado civil, domicilio, 
                            <p>categoría y sueldo, fecha de ingreso al trabajo y al Sindicato) para mantener al corriente el padrón de miembros.</B>
                            <br>
                            <br>

                            <p><B>Actualización de base de datos electrónicos.</B>
                            <p>De manera adicional, utilizaremos su información personal para las siguientes finalidades que no son necesarias para
                            <p>el servicio que otorgamos, pero que nos permiten y facilitan brindarle una mejor atención:
                            <p><B>Análisis estadísticos en el marco de la planeación de actividades sindicales.</B>
                            <br>
                            <br>

                            <p><B>TRANSFERENCIA DE DATOS PERSONALES.</B>
                            <p>Conforme a las actividades propias y con el objetivo de cumplir con la finalidades mencionadas, se podrán transferir
                            <p>algunos de sus datos personales a terceros tales como:
                            <p font="3">INSTITUTO MEXICANO DEL SEGURO SOCIAL, SECRETARÍA DEL TRABAJO Y PREVISIÓN SOCIAL (DIRECCIÓN GENERAL DE
                            <p>REGISTRO DE ASOCIACIONES); CENTRO FEDERAL DE CONCILIACIÓN Y REGISTRO LABORAL; AUTORIDADES LABORALES,
                            <p>ADMINISTRATIVAS O JUDICIALES COMPETENTES; INAI).
                            <p>Quienes se encontrarán obligados a darle a conocer su propio Aviso de Privacidad; lo anterior a fin de evitar daño,
                            <p>pérdida, destrucción, alteración o un tratamiento no autorizado de sus datos personales.
                            <p>En caso de que no desee que sus datos personales sean tratados para estos fines adicionales, desde este momento
                            <p>usted nos puede comunicar lo anterior mediante <B>oficio dirigido a la Undiad de Transparencia del S.N.T.S.S. o la
                            <p>Secretaria del interior y Propaganda del Cómite Ejecutivo Nacional</B>, acompañando <B>los siguientes datos:</B> Nombre del
                            <p>titular, matrícula, adscripción, domicilio, correo electrónico y la descripción exacta de los datos personales
                            <p>adicionales que menciona.
                            <br>
                            <br>

                            <p>Los <B>Derechos</B> ARCO Acceso, Rectificación, Cancelación u oposición podrán ser ejercidos por el titular, previa
                            <p>acreditación de su identidad, mediante <B>oficio dirigido a la Unidad de Transparencia del S.N.T.S.S. a la Secretaría del 
                            <p>Interior y Propaganda del Cómite Ejecutivo Nacional</B> o través del adirección del correo electrónico
                            <p>transparencia.sntss@hotmail.com, debiendo adjuntar copia de su identificación oficial vigente (INE, pasaporte,
                            <p>Cédula Profesional o Cartilla Militar) o través del Representante legal del titular previa acreditación, la identidad del
                            <p>representante y la acreditación de la representación, mediante instrumento notarial, carta poder firmada por el
                            <p>titular y ante la presencia de dos testigos o mediante declaración en comparecencia personal del titular y
                            <p>acompañando los datos del párrafo anterior.
                            <p>En caso de ejecer el derecho de <B> Rectificación</B> de sus datos personales, deberá de indicar la corrección o actualización
                            <p>que requiera se modifiquen, debiendo de aportar los documentos probatorios para sustentar la solicitud. Así mismo
                            <p>le informamos que no se transfieren a terceros sus datos personales recabados en esta cédula.
                            <br>
                            <br>

                            <p>Para mayor información, sobre los términos y condiciones en que serán tratados sus datos personales, así como la
                            <p>actualización de este aviso y la forma en que podrá ejercer sus derechos (ARCO), puede consultar el aviso de 
                            <p>privacidad integral en <U>www.sntss.org.mx/transparencia.</U>
                            """)
    def setFirm(self):
        self.line(35, 220, 75, 220)
        self.set_xy(55, 220.5)
        self.set_font('Arial', '', 5)
        self.cell(12, 3, 'Nombre Completo', 1, 1, 'C')

        self.line(91, 220, 125, 220)
        self.set_xy(102, 220.5)
        self.set_font('Arial', '', 5)
        self.cell(12,3, 'Firma', 1, 1, 'C')

        self.line(130, 220, 170, 220)
        self.set_xy(150, 220.5)
        self.set_font('Arial', '', 5)
        self.cell(12, 3, 'Fecha', 1, 1, 'C')
    ...
    def setAtt(self):
        ...
        self.write_html("""<p>HAGO CONSTAR QUE LA PRESENTE FOTOSTÁTICA ES COPI FIEL DEL ORIGINAL QUE SE TIENE A LA VISTA Y OBRA EN EL ARCHIVO DEL CÓMITE EJECUTIVO
